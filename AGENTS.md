...
python3 /path/to/project-knowledge-officer/scripts/meeting_helpers.py --project-root . validate-project
python3 /path/to/project-knowledge-officer/scripts/meeting_helpers.py --project-root . health-lint
python3 /path/to/project-knowledge-officer/scripts/meeting_helpers.py --project-root . commit -m "Update <project> meeting rollups"
```
